...
//     var status = document.getElementById("submit-text");
...
//   }
  ...
  window.addEventListener("DOMContentLoaded", function() {
    ...
    function success() {
      ...
      status.innerHTML = "Thanks so much for reaching out! I received your email and will get back to you as soon as possible.";
    }

    function error() {
      status.innerHTML = "Please fill in all the required fields";
    }
